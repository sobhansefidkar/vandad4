        ...
        <div className="team w-full h-auto flex justify-center mt-10">
            <div className="team-container w-full h-full max-w-[1100px]">
                <div className=" flex justify-center">
                    <h2 className=" px-3 py-2 border-b border-gray-400 text-2xl">تیم ونداد نوین</h2>
                </div>
                <div className=" team-members w-full h-auto flex flex-wrap justify-center gap-5 my-6">
                    {
                        members.map((item, i) => {
                            return (
                                <div key={i} className="member-card w-64 h-80 bg-white rounded-lg p-1 flex flex-col items-center" ref={elementRef}>
                                    <div className=" w-full h-[96px] flex rounded-lg bg-gray-800 shadow-xl shadow-gray-300">
                                        <div className="w-[30%] flex items-center justify-center">
                                            <img className=" w-14 h-14 object-cover rounded-2xl" src="../../images/sobhan.jpg" alt="" />
                                        </div>
                                        <div className=" flex flex-col w-[70%] h-full justify-center  text-white">
