        ...
        <div className="description w-full h-auto flex justify-center">
            <div className="description-container flex flex-col w-full h-full max-w-[1100px]">
                <div className=" flex justify-center">
                    <h2 className=" px-3 py-2 border-b border-gray-400 text-2xl">شرکت فناوری اطلاعات ونداد نوین</h2>
                </div>
                <div className=" flex flex-col text-[13px] my-5 px-2">
                    <p>با توجه به پیشرفت سریع فناوری و نیازهای رو به رشد بازار ما همیشه در تلاشیم تا خدمات نوآورانه‌تری ارائه دهیم. با تکیه بر تجربه چندین ساله تیم حرفه ای ما , <span className=" font-bold">پایداری , امنیت و کارایی</span> شبکه های خود را تضمین کنید.
                    ...
                    <ul className=" my-5 flex flex-col gap-3">
                        {
                            items.map((item, i) => {
                                return (
                                    <li key={i} className=" w-max flex items-center justify-center gap-3">
