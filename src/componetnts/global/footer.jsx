        ...
        <div className="relative text-sm w-[100vw]">
            ...
            <footer className="bg-gray-900 text-white pt-20 pb-12 ">
                <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 max-w-[1100px]">
                    ...
                    {/* قوانین و شرایط */}
                    <div>
                        <h3 className="font-bold text-lg mb-6 text-blue-400">قوانین و شرایط</h3>
                        <ul className="space-y-3">
                            <li><a href="#" className="hover:text-blue-400 transition duration-300">حریم خصوصی</a></li>
                            <li><a href="#" className="hover:text-blue-400 transition duration-300">سیاست ارسال</a></li>
                            <li><a href="#" className="hover:text-blue-400 transition duration-300">سیاست بازگشت</a></li>
                    ...
                    {/* خبرنامه */}
                    <div>
                        <h3 className="font-bold text-lg mb-6 text-blue-400">خبرنامه</h3>
                        <p className="mb-4 text-gray-300">
                            برای دریافت آخرین به‌روزرسانی‌ها و پیشنهادات ویژه در خبرنامه ما عضو شوید!
                        </p>
                        <div className="flex flex-col space-y-3">
                            <input
                                type="email"
                                placeholder="ایمیل خود را وارد کنید"
                                className="p-3 rounded-lg bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400"
                            />
